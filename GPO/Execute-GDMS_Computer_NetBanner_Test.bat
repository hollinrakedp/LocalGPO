...
goto EndComment
:Comment
Name         - Execute-GDMS_GPO_NetBanner_Test.bat
Version      - 1.0
...
.SYNOPSIS
Apply the GDMS Group Policy for NetBanner Test against the local machine.
...
:Variables
SETLOCAL
set GPO=GDMS - Computer - NetBanner - Unclassified Test System
