...
goto EndComment
:Comment
Name         - Execute-GDMS_GPO_NetBanner_SecretNoForn.bat
Version      - 1.0
...
.SYNOPSIS
Apply the GDMS Group Policy for NetBanner Secret NoForn against the local machine.
...
:Variables
SETLOCAL
set GPO=GDMS - Computer - NetBanner - Secret NoForn
