...
goto EndComment
:Comment
Name         - Execute-GDMS_GPO_AppLockerAudit.bat
Version      - 1.0
...
.SYNOPSIS
Apply the GDMS Group Policy for AppLocker Auditing against the local machine.
...
:Variables
SETLOCAL
set GPO=GDMS - Computer - AppLocker - Audit Only
