...
goto EndComment
:Comment
Name         - Execute-GDMS_GPO_RemovableStorage_Admin_CDDVD_RW.bat
Version      - 1.0
...
.SYNOPSIS
Apply the GDMS Group Policy for allowing the Administrators group Read/Write access to the local CD/DVD drive.
