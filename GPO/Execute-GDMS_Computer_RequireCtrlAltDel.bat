...
goto EndComment
:Comment
Name         - Execute-GDMS_GPO_RequireCtrlAltDel.bat
Version      - 1.0
...
.SYNOPSIS
Apply the GDMS Group Policy for requiring Ctrl+Alt+Del against the local machine.
...
:Variables
SETLOCAL
set GPO=GDMS - Computer - Require Ctrl Alt Del
