...
goto EndComment
:Comment
Name         - Execute-GDMS_GPO_NetBanner_CUI.bat
Version      - 1.0
...
.SYNOPSIS
Apply the GDMS Group Policy for NetBanner Unclassified CUI against the local machine.
...
:Variables
SETLOCAL
set GPO=GDMS - Computer - NetBanner - Unclassified CUI
