...
goto EndComment
:Comment
Name         - Execute-GDMS_GPO_RemovableStorage_DenyAny.bat
Version      - 1.0
...
.SYNOPSIS
Apply the GDMS Group Policy for Removable Storage Deny Any against the local machine.
...
:Variables
SETLOCAL
set GPO=GDMS - User - Removable Storage - Deny Any
