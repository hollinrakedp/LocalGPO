...
goto EndComment
:Comment
Name         - Execute-GDMS_GPO_DisplayPreviousLogonInfo.bat
Version      - 1.0
...
.SYNOPSIS
Apply the GDMS Group Policy for displaying the user's previous logon attempts against the local machine.
...
:Variables
SETLOCAL
set GPO=GDMS - Computer - Display Previous Logon Info
