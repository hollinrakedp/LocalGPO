...
goto EndComment
:Comment
Name         - Execute-GDMS_GPO_DisableCortana.bat
Version      - 1.0
...
.SYNOPSIS
Apply the GDMS Group Policy for disabling Cortana against the local machine.
...
:Variables
SETLOCAL
set GPO=GDMS - Computer - Disable Cortana
